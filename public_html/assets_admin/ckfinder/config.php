...
$config['LicenseName'] = 'LetzGo Internet Services BVBA';
$config['LicenseKey'] = 'UAHP-Q32U-RCPA-5XWC-VKG4-PYAJ-ERBN';
...
*/
$baseUrl = '/public_html/assets_admin/ckfinder/userfiles/';
/*
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'avi,bmp,csv,doc,docx,flv,gif,jpeg,jpg,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,wma,wmv,xls,xlsx,zip,txt',
		'deniedExtensions' => '');
